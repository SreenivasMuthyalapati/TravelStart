...
public class MultiCity {
    ...
    public Object[][] getCityData() throws IOException {
        return new Object[][] {
                ...
                //Domestic Routes
                {m.readDataFromExcel(dataPath,"Oneway Routes",7,0), m.readDataFromExcel(dataPath,"Oneway Routes",7,1), m.readDataFromExcel(dataPath,"URL's",7,2)},
                {m.readDataFromExcel(dataPath,"Oneway Routes",8,0), m.readDataFromExcel(dataPath,"Oneway Routes",8,1), m.readDataFromExcel(dataPath,"URL's",8,2)},
                {m.readDataFromExcel(dataPath,"Oneway Routes",9,0), m.readDataFromExcel(dataPath,"Oneway Routes",9,1), m.readDataFromExcel(dataPath,"URL's",9,2)},

                // International Routes :
                {m.readDataFromExcel(dataPath,"Oneway Routes",2,0), m.readDataFromExcel(dataPath,"Oneway Routes",2,1), m.readDataFromExcel(dataPath,"URL's",2,2)},
                {m.readDataFromExcel(dataPath,"Oneway Routes",3,0), m.readDataFromExcel(dataPath,"Oneway Routes",3,1), m.readDataFromExcel(dataPath,"URL's",3,2)},
                {m.readDataFromExcel(dataPath,"Oneway Routes",4,0), m.readDataFromExcel(dataPath,"Oneway Routes",4,1), m.readDataFromExcel(dataPath,"URL's",4,2)}
        };
    }
