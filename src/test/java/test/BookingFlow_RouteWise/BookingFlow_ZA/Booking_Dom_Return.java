...
public class Booking_Dom_Return {
    ...
    public Object[][] getCityData() throws IOException {
        ...
        int totalRouteCount = m.getRowCount(dataPath, "Domestic Routes");
        for (int i = 1; i < totalRouteCount; i++) { // Start from 1 if data starts from row 2
            String departureCity = m.readDataFromExcel(dataPath, "Domestic Routes", i, 0);
            String returnCity = m.readDataFromExcel(dataPath, "Domestic Routes", i, 1);
